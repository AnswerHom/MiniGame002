...
const ENEMY_TYPES = {
    ...
    阴魂: { hp: 8, hpGrowth: 0.05, attack: 2, attackGrowth: 0.03, exp: 10, speed: 20, attackDistance: 60, stopDistance: 60, color: '#e2e8f0', size: 25, realmColor: '#718096' },
    // 妖狼：灰色毛皮，四足奔跑形态
    ...
    僵尸: { hp: 35, hpGrowth: 0.07, attack: 3, attackGrowth: 0.04, exp: 20, speed: 20, attackDistance: 65, stopDistance: 65, color: '#68d391', size: 40, realmColor: '#68d391' },
    // v1.2.9: 新增怪物
    // 蝴蝶精：彩色翅膀，速度快，血量低
    // 初始HP：12, HP成长：0.04, 初始攻击：4, 攻击成长：0.02
    蝴蝶精: { hp: 6, hpGrowth: 0.04, attack: 2, attackGrowth: 0.02, exp: 8, speed: 60, attackDistance: 50, stopDistance: 50, color: '#f9a8d4', size: 20, realmColor: '#f9a8d4' },
    // 毒蛇：绿色身体，三角形头部
    // 初始HP：20, HP成长：0.05, 初始攻击：12, 攻击成长：0.04
    毒蛇: { hp: 10, hpGrowth: 0.05, attack: 3, attackGrowth: 0.04, exp: 15, speed: 35, attackDistance: 45, stopDistance: 45, color: '#22c55e', size: 35, realmColor: '#22c55e' },
    // 骷髅兵：白色骨架
    ...
    蝙蝠: { hp: 8, hpGrowth: 0.04, attack: 4, attackGrowth: 0.03, exp: 10, speed: 40, attackDistance: 55, stopDistance: 55, color: '#1a1a1a', size: 28, realmColor: '#1a1a1a' },
    // 魔藤：紫色藤蔓，地面生长
